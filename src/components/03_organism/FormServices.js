...
export class FormServices extends PureComponent {
    ...
    render() {
        const { _handleInputChange, email, name, service, budget, servicesOptions, message, deadline } = this.props
        return (
            <ArticleContainer marginBottom="30px">
                ...
                <form>
                    ...
                    <InputTextarea _handleChange={_handleInputChange} value={message} label="message" labelText="Please describe your project*" />
                    <InputSubmit value="Request Booking" bgColor={msTheme.colors.primary} color="white" />
                </form>
            </ArticleContainer>
        )
    }
